...
// Iconos de documentos (Por defecto, utilizado durante el desarrollo)
...
// Paper (alternativa a DefaultIcon)
export const FileDescriptionIcon = ({ className }) => (
  <svg
...
// CV
export const CurriculumIcon = ({ className }) => (
  <svg
    className={`icon icon-filled ${className}`}
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 24 24"
...
// Email de ventas
export const SalesEmailIcon = ({ className }) => (
  <svg
    className={`icon icon-filled ${className}`}
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 24 24"
...
export const RecommendationLetterIcon = ({ className }) => (
  <svg
    className={`icon icon-filled  ${className}`}
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 24 24"
...
export const CoverLetterIcon = ({ className }) => (
  <svg
    className={`icon icon-outline ${className}`}
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 24 24"
...
export const ProductDescriptionIcon = ({ className }) => (
  <svg
    className={`icon icon-filled ${className}`}
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 24 24"
...
// Contrato de trabajo
export const EmploymentContractIcon = ({ className }) => (
  <svg
    className={`icon icon-filled ${className}`}
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 24 24"
...
export const SaleContractIcon = ({ className }) => (
  <svg
    className={`icon icon-outline ${className}`}
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 24 24"
...
export const LeaseContractIcon = ({ className }) => (
  <svg
    className={`icon icon-filled ${className}`}
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 24 24"
...
export const ConfidentialityAgreementIcon = ({ className }) => (
  <svg
    className={`icon icon-outline ${className}`}
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 24 24"
...
// Testamento
export const WillIcon = ({ className }) => (
  <svg
    className={`icon icon-outline ${className}`}
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 24 24"
...
// Acta de Reunión
export const MeetingMinutesIcon = ({ className }) => (
  <svg
    className={`icon icon-outline ${className}`}
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 24 24"
...
// Paper científico
export const ScientificPaperIcon = ({ className }) => (
  <svg
    className={`icon icon-filled ${className}`}
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 24 24"
...
// Tarjeta Anki
export const AnkiCardIcon = ({ className }) => (
  <svg
    className={`icon icon-filled ${className}`}
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 24 24"
...
// Ensayo
export const EssayIcon = ({ className }) => (
  <svg
    className={`icon icon-filled ${className}`}
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 24 24"
...
// Comentario de texto
export const TextCommentaryIcon = ({ className }) => (
  <svg
    className={`icon icon-outline ${className}`}
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 24 24"
...
// Test
export const TestIcon = ({ className }) => (
  <svg
    className={`icon icon-outline ${className}`}
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 24 24"
...
// Examen Práctico
export const PracticalExamIcon = ({ className }) => (
  <svg
    className={`icon icon-outline ${className}`}
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 24 24"
...
// Revisar Redacción
export const WritingReviewIcon = ({ className }) => (
  <svg
    className={`icon icon-filled ${className}`}
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 24 24"
...
// Resumir Texto
export const TextSummaryIcon = ({ className }) => (
  <svg
    className={`icon icon-outline ${className}`}
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 24 24"
...
// Esquematizar Texto
export const TextSchemaIcon = ({ className }) => (
  <svg
    className={`icon icon-filled ${className}`}
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 24 24"
...
// Expandir Texto
export const TextExpandIcon = ({ className }) => (
  <svg
    className={`icon icon-outline ${className}`}
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 24 24"
...
// Pensar Texto
export const TextThinkIcon = ({ className }) => (
  <svg
    className={`icon icon-outline ${className}`}
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 24 24"
...
// Guión Video Youtube
export const YoutubeScriptIcon = ({ className }) => (
  <svg
    className={`icon icon-filled ${className}`}
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 24 24"
...
// Guión Podcast
export const PodcastScriptIcon = ({ className }) => (
  <svg
    className={`icon icon-filled ${className}`}
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 24 24"
...
export const VideoDescriptionIcon = ({ className }) => (
  <svg
    className={`icon icon-outline ${className}`}
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 24 24"
...
// Post Instagram
export const InstagramPostIcon = ({ className }) => (
  <svg
    className={`icon icon-filled ${className}`}
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 24 24"
...
// Post Twitter
export const TwitterPostIcon = ({ className }) => (
  <svg
    className={`icon icon-filled ${className}`}
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 24 24"
...
// Artículo de Opinión
export const OpinionArticleAltIcon = ({ className }) => (
  <svg
    className={`icon icon-outline ${className}`}
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 24 24"
...
export const Icon = ({ iconName, className }) => {
  const IconComponents = {
    default: DefaultIcon,
    "Currículum Vitae Personalizado": CurriculumIcon,
    "Carta de Presentación": CoverLetterIcon,
    "Resumen ejecutivo": FileDescriptionIcon,
    "Descripción de Producto": ProductDescriptionIcon,
    "Email de Ventas": SalesEmailIcon,
    "Carta de Recomendación": RecommendationLetterIcon,
    "Contrato Laboral": EmploymentContractIcon,
    "Contrato de Compraventa": SaleContractIcon,
    "Contrato de Arrendamiento": LeaseContractIcon,
    "Acuerdo de Confidencialidad": ConfidentialityAgreementIcon,
    Testamento: WillIcon,
    "Acta de Reunión": MeetingMinutesIcon,
    "Abstract Científico": ScientificPaperIcon,
    "Tarjeta Anki": AnkiCardIcon,
    Ensayo: EssayIcon,
    "Comentario de Texto": TextCommentaryIcon,
    Test: TestIcon,
    "Examen de Problemas": PracticalExamIcon,
    "Revisar Redacción": WritingReviewIcon,
    "Resumir Texto": TextSummaryIcon,
    "Esquematizar Texto": TextSchemaIcon,
    "Extender Texto": TextExpandIcon,
    "Prensar Texto": TextThinkIcon,
    "Guión para vídeo de Youtube": YoutubeScriptIcon,
    "Guión para Podcast": PodcastScriptIcon,
    "Descripción para Youtube": VideoDescriptionIcon,
    "Post para Instagram": InstagramPostIcon,
    "Post para Twitter": TwitterPostIcon,
    "Artículo de Opinión": OpinionArticleIcon,
  };
  return IconComponents[iconName]
    ? IconComponents[iconName]({ className })
    : IconComponents.default({ className });
};
